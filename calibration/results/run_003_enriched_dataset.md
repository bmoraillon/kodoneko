...
**Configuration :** `defaults v2.2/v0.7 (paliers level 15/35/60) — dataset n=45`
...
|---|---|---|---|
| Accord catégoriel (niveau) | 60.0% | ≥ 70 % | ✗ |
| RMSE sur risk (0-100) | 12.7 | ≤ 15 | ✓ |
| Corrélation Spearman | 0.968 | ≥ 0.80 | ✓ |
| Biais signé moyen | -11.2 | — | sous-estime |
| Distance moyenne en rang | 0.40 | ≤ 0.5 | ✓ |

## Par langage

| Langage | n | Accord | RMSE | Biais | Spearman |
|---|---|---|---|---|---|
| python | 15 | 66.7% | 12.2 | -10.3 | 0.950 |
| typescript | 15 | 60.0% | 11.6 | -10.5 | 0.982 |
| java | 15 | 53.3% | 14.0 | -12.7 | 0.969 |
...
| java_008 | jav | high / 52 | moderate / 31.3 | -20.7 | ✗ (high→moderate) |
| java_009 | jav | very_high / 72 | very_high / 61.1 | -10.9 | ✓ |
| java_010 | jav | very_high / 76 | high / 52.6 | -23.4 | ✗ (very_high→high) |
| java_011 | jav | moderate / 18 | low / 5.3 | -12.7 | ✗ (moderate→low) |
| java_012 | jav | high / 40 | moderate / 20.6 | -19.4 | ✗ (high→moderate) |
| java_013 | jav | moderate / 20 | low / 13.4 | -6.6 | ✗ (moderate→low) |
...
| py_009 | pyt | very_high / 72 | high / 59.6 | -12.4 | ✗ (very_high→high) |
| py_010 | pyt | very_high / 78 | high / 56.1 | -21.9 | ✗ (very_high→high) |
| py_011 | pyt | moderate / 16 | low / 5.4 | -10.6 | ✗ (moderate→low) |
| py_012 | pyt | high / 38 | moderate / 16.3 | -21.7 | ✗ (high→moderate) |
| py_013 | pyt | moderate / 18 | low / 11.5 | -6.5 | ✗ (moderate→low) |
...
| ts_012 | typ | high / 40 | moderate / 27.8 | -12.2 | ✗ (high→moderate) |
...
- **Prédit**  : risk=56.1, level=`high`, cognitive=32
- **Δ risk** : -21.9
...
- **Prédit**  : risk=31.3, level=`moderate`, cognitive=16
- **Δ risk** : -20.7
...
- **Prédit**  : risk=52.6, level=`high`, cognitive=28
- **Δ risk** : -23.4
